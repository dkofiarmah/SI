        ...
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600">
              Join Savannah Intelligence for comprehensive regional analysis
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
            <SignUp
              appearance={{
                elements: {
                  formButtonPrimary: "w-full rounded-md bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 transition-colors",
